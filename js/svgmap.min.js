function svgMapWrapper(t) {
    ...
    return l.prototype.init = function(l) {
        ...
        ZM: "Zambia",
        ZW: "Zimbabwe"
    }, l.prototype.applyData = function(i) {
        var n = null,
            o = null;
        Object.keys(i.values).forEach(function(l) {
            l = parseInt(i.values[l][i.applyData], 10);
            (n = null === n ? l : n) < l && (n = l), l < (o = null === o ? l : o) && (o = l)
        }), i.data[i.applyData].thresholdMax && (n = Math.min(n, i.data[i.applyData].thresholdMax)), i.data[i.applyData].thresholdMin && (o = Math.max(o, i.data[i.applyData].thresholdMin)), Object.keys(this.countries).forEach(function(l) {
            var t, e = document.getElementById(this.id + "-map-country-" + l);
            e && (i.values[l] ? void 0 === i.values[l].color ? (t = Math.max(o, parseInt(i.values[l][i.applyData], 10)), t = Math.max(0, Math.min(1, (t - o) / (n - o))), t = this.getColor(this.options.colorMax, this.options.colorMin, t || 0 === t ? t : 1), e.setAttribute("fill", t)) : e.setAttribute("fill", i.values[l].color) : e.setAttribute("fill", this.options.colorNoData))
        }.bind(this))
        ...
        ["in", "out"].forEach(function(l) {
            ...
            this[t] = this.createElement("button", "svgMap-control-button svgMap-zoom-button svgMap-zoom-" + l + "-button", e), this[t].type = "button", this[t].addEventListener("click", function() {
                this.zoomMap(l)
            }.bind(this), {
                passive: !0
            })
        }.bind(this)), this.zoomControlIn.setAttribute("aria-label", "Zoom in"), this.zoomControlOut.setAttribute("aria-label", "Zoom out");
        l = Object.assign({}, this.mapPaths);
        this.options.countries.EH || (l.MA.d = l["MA-EH"].d, delete l.EH), delete l["MA-EH"], "RU" === this.options.countries.Crimea && (l.RU.d = l["RU-WITH-CRIMEA"].d, l.UA.d = l["UA-WITHOUT-CRIMEA"].d), delete l["RU-WITH-CRIMEA"], delete l["UA-WITHOUT-CRIMEA"], this.tooltipMoveEvent = function(l) {
            this.moveTooltip(l)
        }.bind(this), Object.keys(l).forEach(function(l) {
            var t = this.mapPaths[l];
            if (t.d) {
                var n = document.createElementNS("http://www.w3.org/2000/svg", "path");
                if (n.setAttribute("d", t.d), n.setAttribute("id", this.id + "-map-country-" + l), n.setAttribute("data-id", l), n.classList.add("svgMap-country"), this.mapImage.appendChild(n), n.addEventListener("touchstart", function(l) {
                        n.parentNode.appendChild(n), n.classList.add("svgMap-active");
                        var t = n.getAttribute("data-id"),
                            e = n.getAttribute("data-link");
                        this.options.touchLink && e ? window.location.href = e : (this.setTooltipContent(this.getTooltipContent(t)), this.showTooltip(l), this.moveTooltip(l), n.addEventListener("touchmove", this.tooltipMoveEvent, {
                            passive: !0
                        }))
                    }.bind(this), {
                        passive: !0
                    }), n.addEventListener("mouseenter", function(l) {
                        n.parentNode.appendChild(n);
                        var t = n.getAttribute("data-id");
                        this.setTooltipContent(this.getTooltipContent(t)), this.showTooltip(l), n.addEventListener("mousemove", this.tooltipMoveEvent, {
                            passive: !0
                        })
                    }.bind(this), {
                        passive: !0
                    }), this.options.data.values && this.options.data.values[l] && this.options.data.values[l].link) {
                    n.setAttribute("data-link", this.options.data.values[l].link), this.options.data.values[l].linkTarget && n.setAttribute("data-link-target", this.options.data.values[l].linkTarget);
                    let i = !1;
                    ...
                    l = function(l) {
                        var t, e;
                        i || (t = n.getAttribute("data-link"), (e = n.getAttribute("data-link-target")) ? window.open(t, e) : window.location.href = t)
                    };
                    n.addEventListener("click", l), n.addEventListener("touchend", l)
                }
                n.addEventListener("mouseleave", function() {
                    this.hideTooltip(), n.removeEventListener("mousemove", this.tooltipMoveEvent, {
                        passive: !0
                    })
                }.bind(this), {
                    passive: !0
                }), n.addEventListener("touchend", function() {
                    this.hideTooltip(), n.classList.remove("svgMap-active"), n.removeEventListener("touchmove", this.tooltipMoveEvent, {
                        passive: !0
                    })
                }.bind(this), {
                    passive: !0
        ...
        this.mapPanZoom = t(this.mapImage, {
            ...
            onZoom: function() {
                s.setControlStatuses()
            },
            beforePan: function(l, t) {
                var e = .85 * s.mapWrapper.offsetWidth,
                    i = .85 * s.mapWrapper.offsetHeight,
                    n = this.getSizes(),
                    o = -((n.viewBox.x + n.viewBox.width) * n.realZoom) + e,
                    a = n.width - e - n.viewBox.x * n.realZoom,
                    e = -((n.viewBox.y + n.viewBox.height) * n.realZoom) + i,
                    n = n.height - i - n.viewBox.y * n.realZoom;
                return {
                    x: Math.max(o, Math.min(a, t.x)),
                    y: Math.max(e, Math.min(n, t.y))
                }
            }
        ...
        var i, t = this.createElement("div", "svgMap-tooltip-content", l);
        return this.options.data.values[e] ? (i = "<table>", Object.keys(this.options.data.data).forEach(function(l) {
            var t = this.options.data.data[l],
                l = this.options.data.values[e][l];
            t.floatingNumbers && (l = l.toFixed(1)), t.thousandSeparator && (l = this.numberWithCommas(l, t.thousandSeparator)), l = t.format ? t.format.replace("{0}", "<span>" + l + "</span>") : "<span>" + l + "</span>", i += "<tr><td>" + (t.name || "") + "</td><td>" + l + "</td></tr>"
        }.bind(this)), i += "</table>", t.innerHTML = i) : this.createElement("div", "svgMap-tooltip-no-data", t).innerHTML = this.options.noDataText, l
        ...
        var t, e, i, n, o = l.pageX || (l.touches && l.touches[0] ? l.touches[0].pageX : null),
            a = l.pageY || (l.touches && l.touches[0] ? l.touches[0].pageY : null);
        null !== o && null !== a && (t = window.innerWidth, e = this.tooltip.offsetWidth, i = this.tooltip.offsetHeight, (n = o - e / 2) <= 6 ? (o = 6 + e / 2, this.tooltipPointer.style.marginLeft = n - 6 + "px") : t - 6 <= n + e ? (o = t - 6 - e / 2, this.tooltipPointer.style.marginLeft = -1 * (t - 6 - l.pageX - e / 2) + "px") : this.tooltipPointer.style.marginLeft = "0px", a - 12 - i <= 6 ? (this.tooltip.classList.add("svgMap-tooltip-flipped"), a += 32) : (this.tooltip.classList.remove("svgMap-tooltip-flipped"), a -= 12), this.tooltip.style.left = o + "px", this.tooltip.style.top = a + "px")
    }, l.prototype.error = function(l) {
        (console.error || console.log)("svgMap error: " + (l || "Unknown error"))
    }, l.prototype.createElement = function(l, t, e, i) {
        var n = document.createElement(l);
        return t && (t = t.split(" ")).forEach(function(l) {
            n.classList.add(l)
        }), i && (n.innerHTML = i), e && e.appendChild(n), n
        ...
        var i = Math.ceil(parseInt(l.substring(0, 2), 16) * e + parseInt(t.substring(0, 2), 16) * (1 - e)),
        ...
        return "#" + this.getHex(i) + this.getHex(n) + this.getHex(e)
    ...
    function s(t, l) {
        if (!o[t]) {
            ...
            e = o[t] = {
                exports: {}
            }, n[t][0].call(e.exports, function(l) {
                return s(n[t][1][l] || l)
            }, e, e.exports, i, n, o, a)
        }
        return o[t].exports
    }
    for (var d = "function" == typeof require && require, l = 0; l < a.length; l++) s(a[l]);
    return s
}({
    1: [function(l, t, e) {
        ...
        t.exports = {
            enable: function(l) {
                ...
                t || (t = document.createElementNS(i.svgNS, "defs"), l.svg.appendChild(t)), t.querySelector("style#svg-pan-zoom-controls-styles") || ((e = document.createElementNS(i.svgNS, "style")).setAttribute("id", "svg-pan-zoom-controls-styles"), e.setAttribute("type", "text/css"), e.textContent = ".svg-pan-zoom-control { cursor: pointer; fill: black; fill-opacity: 0.333; } .svg-pan-zoom-control:hover { fill-opacity: 0.8; } .svg-pan-zoom-control-background { fill: white; fill-opacity: 0.5; } .svg-pan-zoom-control-background { fill-opacity: 0.8; }", t.appendChild(e));
                var e = document.createElementNS(i.svgNS, "g");
                e.setAttribute("id", "svg-pan-zoom-controls"), e.setAttribute("transform", "translate(" + (l.width - 70) + " " + (l.height - 76) + ") scale(0.75)"), e.setAttribute("class", "svg-pan-zoom-control"), e.appendChild(this._createZoomIn(l)), e.appendChild(this._createZoomReset(l)), e.appendChild(this._createZoomOut(l)), l.svg.appendChild(e), l.controlIcons = e
            },
            ...
            _createZoomReset: function(l) {
                ...
                e = document.createElementNS(i.svgNS, "path");
                e.setAttribute("d", "M33.051,20.632c-0.742-0.406-1.854-0.609-3.338-0.609h-7.969v9.281h7.769c1.543,0,2.701-0.188,3.473-0.562c1.365-0.656,2.048-1.953,2.048-3.891C35.032,22.757,34.372,21.351,33.051,20.632z"), e.setAttribute("class", "svg-pan-zoom-control-element"), t.appendChild(e);
                e = document.createElementNS(i.svgNS, "path");
                return e.setAttribute("d", "M170.231,0.5H15.847C7.102,0.5,0.5,5.708,0.5,11.84v38.861C0.5,56.833,7.102,61.5,15.847,61.5h154.384c8.745,0,15.269-4.667,15.269-10.798V11.84C185.5,5.708,178.976,0.5,170.231,0.5z M42.837,48.569h-7.969c-0.219-0.766-0.375-1.383-0.469-1.852c-0.188-0.969-0.289-1.961-0.305-2.977l-0.047-3.211c-0.03-2.203-0.41-3.672-1.142-4.406c-0.732-0.734-2.103-1.102-4.113-1.102h-7.05v13.547h-7.055V14.022h16.524c2.361,0.047,4.178,0.344,5.45,0.891c1.272,0.547,2.351,1.352,3.234,2.414c0.731,0.875,1.31,1.844,1.737,2.906s0.64,2.273,0.64,3.633c0,1.641-0.414,3.254-1.242,4.84s-2.195,2.707-4.102,3.363c1.594,0.641,2.723,1.551,3.387,2.73s0.996,2.98,0.996,5.402v2.32c0,1.578,0.063,2.648,0.19,3.211c0.19,0.891,0.635,1.547,1.333,1.969V48.569z M75.579,48.569h-26.18V14.022h25.336v6.117H56.454v7.336h16.781v6H56.454v8.883h19.125V48.569z M104.497,46.331c-2.44,2.086-5.887,3.129-10.34,3.129c-4.548,0-8.125-1.027-10.731-3.082s-3.909-4.879-3.909-8.473h6.891c0.224,1.578,0.662,2.758,1.316,3.539c1.196,1.422,3.246,2.133,6.15,2.133c1.739,0,3.151-0.188,4.236-0.562c2.058-0.719,3.087-2.055,3.087-4.008c0-1.141-0.504-2.023-1.512-2.648c-1.008-0.609-2.607-1.148-4.796-1.617l-3.74-0.82c-3.676-0.812-6.201-1.695-7.576-2.648c-2.328-1.594-3.492-4.086-3.492-7.477c0-3.094,1.139-5.664,3.417-7.711s5.623-3.07,10.036-3.07c3.685,0,6.829,0.965,9.431,2.895c2.602,1.93,3.966,4.73,4.093,8.402h-6.938c-0.128-2.078-1.057-3.555-2.787-4.43c-1.154-0.578-2.587-0.867-4.301-0.867c-1.907,0-3.428,0.375-4.565,1.125c-1.138,0.75-1.706,1.797-1.706,3.141c0,1.234,0.561,2.156,1.682,2.766c0.721,0.406,2.25,0.883,4.589,1.43l6.063,1.43c2.657,0.625,4.648,1.461,5.975,2.508c2.059,1.625,3.089,3.977,3.089,7.055C108.157,41.624,106.937,44.245,104.497,46.331z M139.61,48.569h-26.18V14.022h25.336v6.117h-18.281v7.336h16.781v6h-16.781v8.883h19.125V48.569z M170.337,20.14h-10.336v28.43h-7.266V20.14h-10.383v-6.117h27.984V20.14z"), e.setAttribute("class", "svg-pan-zoom-control-element"), t.appendChild(e), t
            },
    ...
    2: [function(l, t, e) {
        ...
        i.prototype.init = function(l, t) {
            ...
            t = this.processCTM();
            this.setCTM(t), this.updateCTM()
        }, i.prototype.cacheViewBox = function() {
            var l = this.options.svg.getAttribute("viewBox");
            l ? (l = l.split(/[\s\,]/).filter(function(l) {
                return l
            }).map(parseFloat), this.viewBox.x = l[0], this.viewBox.y = l[1], this.viewBox.width = l[2], this.viewBox.height = l[3], l = Math.min(this.options.width / this.viewBox.width, this.options.height / this.viewBox.height), this.activeState.zoom = l, this.activeState.x = (this.options.width - this.viewBox.width * l) / 2, this.activeState.y = (this.options.height - this.viewBox.height * l) / 2, this.updateCTMOnNextFrame(), this.options.svg.removeAttribute("viewBox")) : this.simpleViewBoxCache()
            ...
            var l, t, e = this.getCTM();
            return (this.options.fit || this.options.contain) && (t = this.options.fit ? Math.min(this.options.width / this.viewBox.width, this.options.height / this.viewBox.height) : Math.max(this.options.width / this.viewBox.width, this.options.height / this.viewBox.height), e.a = t, e.d = t, e.e = -this.viewBox.x * t, e.f = -this.viewBox.y * t), this.options.center && (l = .5 * (this.options.width - (this.viewBox.width + 2 * this.viewBox.x) * e.a), t = .5 * (this.options.height - (this.viewBox.height + 2 * this.viewBox.y) * e.a), e.e = l, e.f = t), this.originalState.zoom = e.a, this.originalState.x = e.e, this.originalState.y = e.f, e
            ...
            var t, e, i, n = this.isZoomDifferent(l),
                o = this.isPanDifferent(l);
            (n || o) && (n && (!1 === this.options.beforeZoom(this.getRelativeZoom(), this.computeRelativeZoom(l.a)) ? (l.a = l.d = this.activeState.zoom, n = !1) : (this.updateCache(l), this.options.onZoom(this.getRelativeZoom()))), o && ((i = e = !1) === (t = this.options.beforePan(this.getPan(), {
                x: l.e,
                y: l.f
            })) ? (l.e = this.getPan().x, l.f = this.getPan().y, e = i = !0) : a.isObject(t) && (!1 === t.x ? (l.e = this.getPan().x, e = !0) : a.isNumber(t.x) && (l.e = t.x), !1 === t.y ? (l.f = this.getPan().y, i = !0) : a.isNumber(t.y) && (l.f = t.y)), e && i || !this.isPanDifferent(l) ? o = !1 : (this.updateCache(l), this.options.onPan(this.getPan()))), (n || o) && this.updateCTMOnNextFrame())
            ...
            var l = this.getCTM();
            n.setCTM(this.viewport, l, this.defs), this.pendingUpdate = !1, this.options.onUpdatedCTM && this.options.onUpdatedCTM(l)
    ...
    3: [function(l, t, e) {
        var i = l("./svg-pan-zoom.js");
        l = window, document, "function" == typeof define && define.amd ? define("svg-pan-zoom", function() {
            return i
        }) : void 0 !== t && t.exports && (t.exports = i, l.svgPanZoom = i)
    }, {
        "./svg-pan-zoom.js": 4
    }],
    4: [function(l, t, e) {
        ...
        n.prototype.init = function(l, t) {
            var e = this;
            this.svg = l, this.defs = l.querySelector("defs"), s.setupSvgAttributes(this.svg), this.options = a.extend(a.extend({}, h), t), this.state = "none";
            l = s.getBoundingClientRectNormalized(l);
            this.width = l.width, this.height = l.height, this.viewport = d(s.getOrCreateViewport(this.svg, this.options.viewportSelector), {
                svg: this.svg,
                width: this.width,
                height: this.height,
            ...
            l = this.getPublicInstance();
            l.setBeforeZoom(this.options.beforeZoom), l.setOnZoom(this.options.onZoom), l.setBeforePan(this.options.beforePan), l.setOnPan(this.options.onPan), l.setOnUpdatedCTM(this.options.onUpdatedCTM), this.options.controlIconsEnabled && o.enable(this), this.lastMouseWheelEventTime = Date.now(), this.setupHandlers()
        }, n.prototype.setupHandlers = function() {
            var l, e = this,
                i = null;
            if (this.eventListeners = {
                    mousedown: function(l) {
                        var t = e.handleMouseDown(l, i);
                        return i = l, t
                    },
                ...
                if (t && t.length)
                    for (var n = t.length - 1; 0 <= n; n--) this.eventListeners.hasOwnProperty(t[n]) && delete this.eventListeners[t[n]]
            }
            for (l in this.eventListeners)(this.options.eventsListenerElement || this.svg).addEventListener(l, this.eventListeners[l], !this.options.preventMouseEventsDefault && p);
            ...
            var t, l;
            this.options.mouseWheelZoomEnabled || ((t = this).wheelListener = function(l) {
                return t.handleMouseWheel(l)
            }, l = !this.options.preventMouseEventsDefault, i.on(this.options.eventsListenerElement || this.svg, this.wheelListener, l), this.options.mouseWheelZoomEnabled = !0)
        }, n.prototype.disableMouseWheelZoom = function() {
            var l;
            this.options.mouseWheelZoomEnabled && (l = !this.options.preventMouseEventsDefault, i.off(this.options.eventsListenerElement || this.svg, this.wheelListener, l), this.options.mouseWheelZoomEnabled = !1)
        }, n.prototype.handleMouseWheel = function(l) {
            var t, e;
            this.options.zoomEnabled && "none" === this.state && (this.options.preventMouseEventsDefault && (l.preventDefault ? l.preventDefault() : l.returnValue = !1), e = l.deltaY || 1, t = Date.now() - this.lastMouseWheelEventTime, t = 3 + Math.max(0, 30 - t), this.lastMouseWheelEventTime = Date.now(), e = -.3 < (e = "deltaMode" in l && 0 === l.deltaMode && l.wheelDelta ? 0 === l.deltaY ? 0 : Math.abs(l.wheelDelta) / l.deltaY : e) && e < .3 ? e : (0 < e ? 1 : -1) * Math.log(Math.abs(e) + 10) / t, t = this.svg.getScreenCTM().inverse(), t = s.getEventPoint(l, this.svg).matrixTransform(t), e = Math.pow(1 + this.options.zoomScaleSensitivity, -1 * e), this.zoomAtPoint(e, t))
        }, n.prototype.zoomAtPoint = function(l, t, e) {
            var i = this.viewport.getOriginalState();
            e ? (l = Math.max(this.options.minZoom * i.zoom, Math.min(this.options.maxZoom * i.zoom, l)), l /= this.getZoom()) : this.getZoom() * l < this.options.minZoom * i.zoom ? l = this.options.minZoom * i.zoom / this.getZoom() : this.getZoom() * l > this.options.maxZoom * i.zoom && (l = this.options.maxZoom * i.zoom / this.getZoom());
            i = this.viewport.getCTM(), t = t.matrixTransform(i.inverse()), t = this.svg.createSVGMatrix().translate(t.x, t.y).scale(l).translate(-t.x, -t.y), t = i.multiply(t);
            t.a !== i.a && this.viewport.setCTM(t)
        }, n.prototype.zoom = function(l, t) {
            this.zoomAtPoint(l, s.getSvgCenterPoint(this.svg, this.width, this.height), t)
            ...
            if (e && (l = this.computeFromRelativeZoom(l)), "SVGPoint" !== a.getType(t)) {
                if (!("x" in t && "y" in t)) throw new Error("Given point is invalid");
                t = s.createSVGPoint(this.svg, t.x, t.y)
            }
            ...
            var t = l.shiftKey ? 1 / (2 * (1 + this.options.zoomScaleSensitivity)) : 2 * (1 + this.options.zoomScaleSensitivity),
                l = s.getEventPoint(l, this.svg).matrixTransform(this.svg.getScreenCTM().inverse());
            this.zoomAtPoint(t, l)
        }, n.prototype.handleMouseDown = function(l, t) {
            this.options.preventMouseEventsDefault && (l.preventDefault ? l.preventDefault() : l.returnValue = !1), a.mouseAndTouchNormalize(l, this.svg), this.options.dblClickZoomEnabled && a.isDblClick(l, t) ? this.handleDblClick(l) : (this.state = "pan", this.firstEventCTM = this.viewport.getCTM(), this.stateOrigin = s.getEventPoint(l, this.svg).matrixTransform(this.firstEventCTM.inverse()))
        }, n.prototype.handleMouseMove = function(l) {
            this.options.preventMouseEventsDefault && (l.preventDefault ? l.preventDefault() : l.returnValue = !1), "pan" === this.state && this.options.panEnabled && (l = s.getEventPoint(l, this.svg).matrixTransform(this.firstEventCTM.inverse()), l = this.firstEventCTM.translate(l.x - this.stateOrigin.x, l.y - this.stateOrigin.y), this.viewport.setCTM(l))
            ...
            var l = this.viewport.getViewBox(),
                l = Math.min(this.width / l.width, this.height / l.height);
            this.zoom(l, !0)
        }, n.prototype.contain = function() {
            var l = this.viewport.getViewBox(),
                l = Math.max(this.width / l.width, this.height / l.height);
            this.zoom(l, !0)
        }, n.prototype.center = function() {
            var l = this.viewport.getViewBox(),
                t = .5 * (this.width - (l.width + 2 * l.x) * this.getZoom()),
                l = .5 * (this.height - (l.height + 2 * l.y) * this.getZoom());
            ...
            var l = s.getBoundingClientRectNormalized(this.svg);
            ...
            var l, t = this;
            for (l in this.beforeZoom = null, this.onZoom = null, this.beforePan = null, this.onPan = null, (this.onUpdatedCTM = null) != this.options.customEventsHandler && this.options.customEventsHandler.destroy({
                    svgElement: this.svg,
                    eventsListenerElement: this.options.eventsListenerElement,
                    instance: this.getPublicInstance()
                }), this.eventListeners)(this.options.eventsListenerElement || this.svg).removeEventListener(l, this.eventListeners[l], !this.options.preventMouseEventsDefault && p);
            this.disableMouseWheelZoom(), this.getPublicInstance().disableControlIcons(), this.reset(), r = r.filter(function(l) {
                return l.svg !== t.svg
            ...
            return this.publicInstance || (this.publicInstance = this.pi = {
                ...
                setBeforePan: function(l) {
                    return e.options.beforePan = null === l ? null : a.proxy(l, e.publicInstance), e.pi
                },
                setOnPan: function(l) {
                    return e.options.onPan = null === l ? null : a.proxy(l, e.publicInstance), e.pi
                },
                enableZoom: function() {
                ...
                enableControlIcons: function() {
                    return e.options.controlIconsEnabled || (e.options.controlIconsEnabled = !0, o.enable(e)), e.pi
                },
                disableControlIcons: function() {
                    return e.options.controlIconsEnabled && (e.options.controlIconsEnabled = !1, o.disable(e)), e.pi
                },
                ...
                setBeforeZoom: function(l) {
                    return e.options.beforeZoom = null === l ? null : a.proxy(l, e.publicInstance), e.pi
                },
                setOnZoom: function(l) {
                    return e.options.onZoom = null === l ? null : a.proxy(l, e.publicInstance), e.pi
                },
                zoom: function(l) {
                ...
                setOnUpdatedCTM: function(l) {
                    return e.options.onUpdatedCTM = null === l ? null : a.proxy(l, e.publicInstance), e.pi
                },
                resetZoom: function() {
        ...
        t.exports = function(l, t) {
            ...
            for (var i = r.length - 1; 0 <= i; i--)
                if (r[i].svg === e) return r[i].instance.getPublicInstance();
            return r.push({
                svg: e,
                instance: new n(e, t)
            }), r[r.length - 1].instance.getPublicInstance()
        }
    }, {
        "./control-icons": 1,
        "./shadow-viewport": 2,
    ...
    5: [function(l, t, e) {
        ...
        document.documentMode && (n = "ie"), t.exports = {
            ...
            getOrCreateViewport: function(l, t) {
                var e = null;
                if ((e = a.isElement(t) ? t : l.querySelector(t)) || 1 === (i = Array.prototype.slice.call(l.childNodes || l.children).filter(function(l) {
                        return "defs" !== l.nodeName && "#text" !== l.nodeName
                    })).length && "g" === i[0].nodeName && null === i[0].getAttribute("transform") && (e = i[0]), !e) {
                    ...
                    if (n && 0 < n.length)
                        for (var o = n.length; 0 < o; o--) "defs" !== n[n.length - o].nodeName && e.appendChild(n[n.length - o]);
                    l.appendChild(e)
                }
                l = [];
                return ~(l = e.getAttribute("class") ? e.getAttribute("class").split(" ") : l).indexOf("svg-pan-zoom_viewport") || (l.push("svg-pan-zoom_viewport"), e.setAttribute("class", l.join(" "))), e
            },
            setupSvgAttributes: function(l) {
                var t;
                l.setAttribute("xmlns", this.svgNS), l.setAttributeNS(this.xmlnsNS, "xmlns:xlink", this.xlinkNS), l.setAttributeNS(this.xmlnsNS, "xmlns:ev", this.evNS), null === l.parentNode || -1 === (t = l.getAttribute("style") || "").toLowerCase().indexOf("overflow") && l.setAttribute("style", "overflow: hidden; " + t)
            },
            internetExplorerRedisplayInterval: 300,
            refreshDefsGlobal: a.throttle(function() {
            ...
            setCTM: function(l, t, e) {
                ...
                l.setAttributeNS(null, "transform", t), "transform" in l.style ? l.style.transform = t : "-ms-transform" in l.style ? l.style["-ms-transform"] = t : "-webkit-transform" in l.style && (l.style["-webkit-transform"] = t), "ie" === n && e && (e.parentNode.insertBefore(e, e), window.setTimeout(function() {
                    i.refreshDefsGlobal()
                }, i.internetExplorerRedisplayInterval))
            },
            getEventPoint: function(l, t) {
                var e = t.createSVGPoint();
                return a.mouseAndTouchNormalize(l, t), e.x = l.clientX, e.y = l.clientY, e
            },
    ...
    6: [function(l, t, e) {
        function n(l, e) {
            function t(l) {
                var t = {
                    originalEvent: l = l || window.event,
                ...
                return "mousewheel" == d ? (t.deltaY = -.025 * l.wheelDelta, l.wheelDeltaX && (t.deltaX = -.025 * l.wheelDeltaX)) : t.deltaY = l.detail, e(t)
            }
            return p.push({
                element: l,
                fn: t
        ...
        t.exports = (p = [], r = {
            passive: !(h = "")
        }, window.addEventListener ? (a = "addEventListener", s = "removeEventListener") : (a = "attachEvent", s = "detachEvent", h = "on"), d = "onwheel" in document.createElement("div") ? "wheel" : void 0 !== document.onmousewheel ? "mousewheel" : "DOMMouseScroll", {
            on: function(l, t, e) {
                i(l, d, t, e), "DOMMouseScroll" == d && i(l, "MozMousePixelScroll", t, e)
            },
            off: function(l, t, e) {
                o(l, d, t, e), "DOMMouseScroll" == d && o(l, "MozMousePixelScroll", t, e)
            }
        })
    }, {}],
    7: [function(l, t, e) {
        ...
        t.exports = {
            ...
            mouseAndTouchNormalize: function(l, t) {
                void 0 !== l.clientX && null !== l.clientX || (l.clientX = 0, void(l.clientY = 0) !== l.touches && l.touches.length ? void 0 !== l.touches[0].clientX ? (l.clientX = l.touches[0].clientX, l.clientY = l.touches[0].clientY) : void 0 !== l.touches[0].pageX && (t = t.getBoundingClientRect(), l.clientX = l.touches[0].pageX - t.left, l.clientY = l.touches[0].pageY - t.top) : void 0 !== l.originalEvent && void 0 !== l.originalEvent.clientX && (l.clientX = l.originalEvent.clientX, l.clientY = l.originalEvent.clientY))
            },
            isDblClick: function(l, t) {
                if (2 === l.detail) return !0;
                if (null == t) return !1;
                var e = l.timeStamp - t.timeStamp,
                    t = Math.sqrt(Math.pow(l.clientX - t.clientX, 2) + Math.pow(l.clientY - t.clientY, 2));
                return e < 250 && t < 10
            },
            ...
            throttle: function(e, i, n) {
                ...
                function r() {
                    p = !1 === n.leading ? 0 : d.now(), h = null, s = e.apply(o, a), h || (o = a = null)
                }
                return function() {
                    var l = d.now();
                    p || !1 !== n.leading || (p = l);
                    var t = i - (l - p);
                    return o = this, a = arguments, t <= 0 || i < t ? (clearTimeout(h), h = null, p = l, s = e.apply(o, a), h || (o = a = null)) : h || !1 === n.trailing || (h = setTimeout(r, t)), s
                }
            },
            createRequestAnimationFrame: function(l) {
                var t = null;
                return null === (t = "auto" !== l && l < 60 && 1 < l ? Math.floor(1e3 / l) : t) ? window.requestAnimationFrame || i(33) : i(t)
            }
        }
    }, {}]
}, {}, [3]),
function(t, e) {
    "function" == typeof define && define.amd ? define(["svg-pan-zoom"], function(l) {
        return t.svgMap = e(l)
    }) : "object" == typeof module && module.exports ? module.exports = t.svgMap = e(require("svg-pan-zoom")) : t.svgMap = e(t.svgPanZoom)
}(this, function(l) {
